...
<%@ include file="../layout/navbar.jsp"%>
    ...
    <body>
        <a href="${pageContext.request.contextPath}/sortie/detail?id=12487" class="float-right btn btn-outline-primary" style="margin-left: 10px;">Consulter les sorties</a>
